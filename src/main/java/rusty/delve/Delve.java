...
public class Delve
{
    ...
    public static final String MODID = "delvecore";
    ...
    public static void onRegisterItems(final RegistryEvent.Register<Item> event)
    {
    	...
    	{ 
    		event.getRegistry().register(new BlockItem(block, new Item.Properties().tab(Misc.misc)).setRegistryName(block.getRegistryName())); 
    	});
    }
}